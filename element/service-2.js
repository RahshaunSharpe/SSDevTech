				...
				<div className="row icon-wraper-1">
					...
					<div className={`${open === "p1" ? "icon-bx-wraper style-3 m-b30 box-hover wow fadeInUp active" : "icon-bx-wraper style-3 m-b30 box-hover wow fadeInUp"}`} onMouseOver={() => setOpen("p1")}>
							...
							<div className="icon-content">
								<h4 className="dlab-title m-b15">Content creation</h4>
								<p>Great content is likely to be shared, which can help with link building. But for purely SEO purposes, content is what search engines need to determine how relevant your website is to a specific keyword or keyphrase.</p>
							</div>
						</div>
					</div>
					<div className="col-lg-4 col-md-6">
					...
					<div className={`${open === "p4" ? "icon-bx-wraper style-3 m-b30 box-hover wow fadeInUp active" : "icon-bx-wraper style-3 m-b30 box-hover wow fadeInUp"}`} onMouseOver={() => setOpen("p4")}>
							...
							<div className="icon-content">
								...
								<p>Get ranked on search engines, improve your rankings, optimize your website to perform better, assist you with creating content, and much more. Every SEO expert and company is a little different in what they offer, how much they charge, and what results they guarantee for their clients.</p>
							</div>
						</div>
					</div>
					<div className="col-lg-4 col-md-6">
